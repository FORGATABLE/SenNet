...
if not os.path.exists(save_datadir):
    os.makedirs(save_datadir)
...
for case_name in os.listdir(data_dir): # 测试数据
    ...
    for i in unique_values:
        ...
        centroid_y = int(torch.mean(idx_y.float()))  + random.randint(30, 45)
        ...
        Mask_path = save_labeldir +case_name + '_2' + '.nii.gz'
        ...
        CT_path = save_datadir + case_name + '_2_0000.nii.gz'
